...
export const uz_latn = {
  ...
  'nav.myPayments': 'Mening toʻlovlarim',
  ...
  // `GET /refunds` with no `application_id` answer the caller's own rows for
  // an applicant).
  'myPayments.title': 'Mening toʻlovlarim',
  'myPayments.subtitle': 'Hisob-fakturalar, toʻlovlar va qaytarish soʻrovlari — bir joyda.',
  'myPayments.tabs.invoices': 'Hisob-fakturalar',
  'myPayments.tabs.refunds': 'Qaytarishlar',
  'myPayments.filterAll': 'Barchasi',
  'myPayments.invoices.colNumber': 'Hisob-faktura',
  'myPayments.invoices.colApplication': 'Ariza',
  'myPayments.invoices.colAmount': 'Summa',
  'myPayments.invoices.colStatus': 'Holati',
  'myPayments.invoices.colIssued': 'Berilgan sana',
  'myPayments.invoices.colDue': 'Toʻlash muddati',
  'myPayments.invoices.pay': 'Toʻlash',
  'myPayments.invoices.open': 'Koʻrish',
  'myPayments.invoices.empty': 'Hali hisob-faktura yoʻq.',
  'myPayments.invoices.emptyHint': 'Ariza tasdiqlangach, hisob-faktura shu yerda paydo boʻladi.',
  'myPayments.invoices.loadFailed': 'Hisob-fakturalarni yuklab boʻlmadi.',
  'myPayments.refunds.colApplication': 'Ariza',
  'myPayments.refunds.colBasis': 'Asos',
  'myPayments.refunds.colFinal': 'Qaytariladigan summa',
  'myPayments.refunds.colStatus': 'Holati',
  'myPayments.refunds.colRequestedAt': 'Soʻralgan sana',
  'myPayments.refunds.colDue': 'Javob muddati',
  'myPayments.refunds.colDecidedAt': 'Qaror sanasi',
  'myPayments.refunds.pendingDecision': 'Qaror kutilmoqda',
  'myPayments.refunds.newRequest': 'Qaytarish soʻrash',
  'myPayments.refunds.empty': 'Qaytarish soʻrovlari yoʻq.',
  'myPayments.refunds.loadFailed': 'Qaytarishlarni yuklab boʻlmadi.',
  'myPayments.refunds.reasonsLoadFailed': 'Qaytarish asoslarini yuklab boʻlmadi.',
  'myPayments.refunds.loadingLists': 'Yuklanmoqda…',
  'myPayments.refunds.applicationLabel': 'Ariza',
  'myPayments.refunds.basisLabel': 'Asos',
  'myPayments.refunds.commentLabel': 'Izoh',
  'myPayments.refunds.submit': 'Yuborish',
  'myPayments.refunds.cancel': 'Bekor qilish',
  'myPayments.refunds.noBillableApplications': 'Hisob-fakturasi bor ariza topilmadi — qaytarish soʻrash uchun avval toʻlov boʻlishi kerak.',
  'myPayments.refunds.requestFailed': 'Soʻrovni yuborib boʻlmadi.',
