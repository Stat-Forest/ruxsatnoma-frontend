...
export const uz_latn = {
  ...
  'nav.benefitVerification': 'Imtiyozlarni tekshirish',
  'benefitVerification.title': 'Imtiyoz sertifikatlarini tekshirish',
  'benefitVerification.subtitle':
    "Sertifikat talab qiladigan imtiyoz da'vo qilingan arizalar — butun respublika boʻyicha",
  'benefitVerification.filters.status': 'Holat',
  'benefitVerification.filters.all': 'Barchasi',
  'benefitVerification.filters.pending': 'Kutilmoqda',
  'benefitVerification.filters.verified': 'Tasdiqlangan',
  'benefitVerification.filters.rejected': 'Rad etilgan',
  'benefitVerification.col.certificateNo': 'Sertifikat raqami',
  'benefitVerification.col.applicant': 'Arizachi',
  'benefitVerification.col.activity': 'Faoliyat turi',
  'benefitVerification.col.waiting': 'Kutish muddati',
  'benefitVerification.col.status': 'Holat',
  'benefitVerification.col.view': 'Koʻrish',
  'benefitVerification.status.pending': 'Kutilmoqda',
  'benefitVerification.status.verified': 'Tasdiqlangan',
  'benefitVerification.status.rejected': 'Rad etilgan',
  'benefitVerification.empty': "Sertifikat talab qiluvchi arizalar topilmadi.",
  'benefitVerification.loading': 'Yuklanmoqda…',
  'benefitVerification.loadError': "Roʻyxatni yuklab boʻlmadi.",
  'benefitVerification.detail.title': "Imtiyoz da'vosi",
  'benefitVerification.detail.certificateNo': 'Sertifikat raqami:',
  'benefitVerification.detail.noCertificateNo': 'Koʻrsatilmagan',
  'benefitVerification.detail.applicant': 'Arizachi (ID):',
  'benefitVerification.detail.activity': 'Faoliyat turi:',
  'benefitVerification.detail.period': 'Soʻralgan davr:',
  'benefitVerification.detail.submittedAt': 'Yuborilgan sana:',
  'benefitVerification.detail.status': "Da'vo holati:",
  'benefitVerification.detail.decidedBy': 'Qaror qabul qildi (ID):',
  'benefitVerification.detail.decidedAt': 'Qaror sanasi:',
  'benefitVerification.detail.rejectionReason': 'Rad etish sababi:',
  'benefitVerification.detail.loadFailed': "Da'voni yuklab boʻlmadi.",
  'benefitVerification.detail.documents.title': 'Ilova qilingan hujjatlar',
  'benefitVerification.detail.documents.empty': 'Hujjat biriktirilmagan.',
  'benefitVerification.detail.documents.download': 'Yuklab olish',
  'benefitVerification.detail.documents.fallbackName': 'Hujjat',
  'benefitVerification.actions.verify': 'Tasdiqlash',
  'benefitVerification.actions.reject': 'Rad etish',
  'benefitVerification.actions.verifyError': "Tasdiqlab boʻlmadi.",
  'benefitVerification.reject.title': "Da'voni rad etish",
  'benefitVerification.reject.reasonLabel': 'Rad etish sababi',
  'benefitVerification.reject.reasonPlaceholder': 'Sertifikat nima uchun tasdiqlanmayotganini yozing',
  'benefitVerification.reject.reasonRequired': 'Rad etish sababini kiritish shart.',
