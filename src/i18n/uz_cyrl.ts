...
export const uz_cyrl = {
  ...
  'nav.myPayments': 'Менинг тўловларим',
  ...
  'login.back': 'Орқага',
  'login.forgotLink': 'Паролни унутдингизми?',
  'login.forgotTitle': 'Паролни тиклаш',
  'login.forgotNext': 'Давом этиш',
  'login.forgotChannelTitle': 'Код қаерга юборилсин?',
  'login.forgotPhone': 'Телефон',
  'login.forgotEmail': 'E-mail',
  'login.forgotNotFilled': 'тўлдирилмаган',
  'login.forgotNoContacts': 'Логин топилмади ёки унга телефон ҳам, e-mail ҳам бириктирилмаган. Администраторга мурожаат қилинг.',
  'login.forgotCodeLabel': 'Хабардаги код',
  'login.forgotCodeHelp': '6 та рақам, бир неча дақиқа амал қилади',
  'login.forgotNewPassword': 'Янги парол',
  'login.forgotPolicyHelp': 'Камида 8 та белги: катта ва кичик ҳарфлар, рақам ва махсус белги',
  'login.forgotRepeatPassword': 'Паролни такрорланг',
  'login.forgotSubmit': 'Паролни ўзгартириш',
  'login.forgotMismatch': 'Пароллар мос келмади.',
  'login.forgotWeakPassword': 'Парол талабга жавоб бермайди: камида 8 та белги, катта ва кичик ҳарфлар, рақам ва махсус белги керак.',
  'login.forgotDone': 'Парол ўзгартирилди. Янги парол билан киринг.',
  'login.adminContact': 'Кира олмаяпсизми? Администраторга ёки техник ёрдамга мурожаат қилинг:',
  ...
  'wizard.step3.deadwoodProduct.both': "Ўтин ва шох-шабба",
  'wizard.step3.removalDeadline': "Олиб чиқиш муддати",
  'wizard.step3.recreationPurpose': "Фойдаланиш мақсади",
  'wizard.step3.recreationPurpose.cultural_educational': "Маданий-маърифий",
  'wizard.step3.recreationPurpose.upbringing': "Тарбиявий",
  'wizard.step3.recreationPurpose.health': "Соғломлаштириш",
  'wizard.step3.recreationPurpose.recreational': "Рекреацион",
  'wizard.step3.recreationPurpose.aesthetic': "Эстетик",
  'wizard.step3.eventAt': "Тадбир санаси ва вақти",
  'wizard.step4.benefitCategory': "Имтиёз тоифаси (агар мавжуд бўлса)",
  'wizard.step4.noBenefit': "Имтиёз йўқ",
  ...
  'wizard.step4.certificateNumber': "Гувоҳнома рақами",
  'wizard.step4.certificateNumberRequired': "Танланган имтиёз тоифаси учун гувоҳнома рақами киритилиши шарт.",
  ...
  'wizard.step4.benefitsGroup': "Имтиёзлар",
  'wizard.step4.addDoc': "Ҳужжат қўшиш",
  'wizard.step4.pendingRowHint': "Файлни танланг ёки қаторни олиб ташланг.",
  ...
  'gis.map.loading': 'Юкланмоқда...',
  'gis.map.zoomInHint': 'Контурларни кўриш учун харитани катталаштиринг',
  'gis.map.contourCount': '{n} та контур',
  ...
  'myPayments.title': 'Менинг тўловларим',
  'myPayments.subtitle': 'Ҳисоб-фактуралар, тўловлар ва қайтариш сўровлари — бир жойда.',
  'myPayments.tabs.invoices': 'Ҳисоб-фактуралар',
  'myPayments.tabs.refunds': 'Қайтаришлар',
  'myPayments.filterAll': 'Барчаси',
  'myPayments.invoices.colNumber': 'Ҳисоб-фактура',
  'myPayments.invoices.colApplication': 'Ариза',
  'myPayments.invoices.colAmount': 'Сумма',
  'myPayments.invoices.colStatus': 'Ҳолати',
  'myPayments.invoices.colIssued': 'Берилган сана',
  'myPayments.invoices.colDue': 'Тўлаш муддати',
  'myPayments.invoices.pay': 'Тўлаш',
  'myPayments.invoices.open': 'Кўриш',
  'myPayments.invoices.empty': 'Ҳали ҳисоб-фактура йўқ.',
  'myPayments.invoices.emptyHint': 'Ариза тасдиқлангач, ҳисоб-фактура шу ерда пайдо бўлади.',
  'myPayments.invoices.loadFailed': 'Ҳисоб-фактураларни юклаб бўлмади.',
  'myPayments.refunds.colApplication': 'Ариза',
  'myPayments.refunds.colBasis': 'Асос',
  'myPayments.refunds.colFinal': 'Қайтариладиган сумма',
  'myPayments.refunds.colStatus': 'Ҳолати',
  'myPayments.refunds.colRequestedAt': 'Сўралган сана',
  'myPayments.refunds.colDue': 'Жавоб муддати',
  'myPayments.refunds.colDecidedAt': 'Қарор санаси',
  'myPayments.refunds.pendingDecision': 'Қарор кутилмоқда',
  'myPayments.refunds.newRequest': 'Қайтариш сўраш',
  'myPayments.refunds.empty': 'Қайтариш сўровлари йўқ.',
  'myPayments.refunds.loadFailed': 'Қайтаришларни юклаб бўлмади.',
  'myPayments.refunds.reasonsLoadFailed': 'Қайтариш асосларини юклаб бўлмади.',
  'myPayments.refunds.loadingLists': 'Юкланмоқда…',
  'myPayments.refunds.applicationLabel': 'Ариза',
  'myPayments.refunds.basisLabel': 'Асос',
  'myPayments.refunds.commentLabel': 'Изоҳ',
  'myPayments.refunds.submit': 'Юбориш',
  'myPayments.refunds.cancel': 'Бекор қилиш',
  'myPayments.refunds.noBillableApplications': 'Ҳисоб-фактураси бор ариза топилмади — қайтариш сўраш учун аввал тўлов бўлиши керак.',
  'myPayments.refunds.requestFailed': 'Сўровни юбориб бўлмади.',
  'myPayments.refunds.requestNotFound': 'Бу ариза бўйича ҳисоб-фактура топилмади.',
