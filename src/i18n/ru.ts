...
export const ru = {
  ...
  'dash.deadlines.title': 'Сроки',
  'dash.deadlines.subtitle': 'Сроки действия разрешений и рассмотрения заявок',
  'dash.deadlines.expiryHeading': 'Срок действия — по видам разрешений',
  'dash.deadlines.daysLeft': 'дн. осталось',
  'dash.deadlines.reviewHeading': 'Срок рассмотрения заявки',
  'dash.deadlines.workDaysLeft': 'раб. дн. осталось',
  'dash.deadlines.dueToday': 'Истекает сегодня',
  ...
  'wizard.step3.typeRequired': 'Выберите вид скота.',
  'wizard.step3.headCountRequired': 'Укажите поголовье.',
  'wizard.step3.headCountInvalid': 'Поголовье должно быть целым числом от 1 до 1 000 000.',
  'wizard.step3.selectPrompt': 'Выберите...',
  'wizard.step3.addLivestock': 'Добавить вид скота',
  'wizard.step3.quantity': 'Количество',
  'wizard.step3.quantityInvalid': 'Количество должно быть от 0 до максимума, не более 4 знаков после запятой.',
