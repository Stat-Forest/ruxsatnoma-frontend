...
export const ru = {
  ...
  'nav.benefitVerification': 'Проверка льгот',
  'benefitVerification.title': 'Проверка сертификатов на льготы',
  'benefitVerification.subtitle': 'Заявки с льготой, требующей сертификата — по всей республике',
  'benefitVerification.filters.status': 'Статус',
  'benefitVerification.filters.all': 'Все',
  'benefitVerification.filters.pending': 'Ожидают',
  'benefitVerification.filters.verified': 'Подтверждены',
  'benefitVerification.filters.rejected': 'Отклонены',
  'benefitVerification.col.certificateNo': 'Номер сертификата',
  'benefitVerification.col.applicant': 'Заявитель',
  'benefitVerification.col.activity': 'Вид деятельности',
  'benefitVerification.col.waiting': 'Время ожидания',
  'benefitVerification.col.status': 'Статус',
  'benefitVerification.col.view': 'Открыть',
  'benefitVerification.status.pending': 'Ожидает',
  'benefitVerification.status.verified': 'Подтверждена',
  'benefitVerification.status.rejected': 'Отклонена',
  'benefitVerification.empty': 'Заявок с сертификатом-подтверждением льготы не найдено.',
  'benefitVerification.loading': 'Загрузка…',
  'benefitVerification.loadError': 'Не удалось загрузить список.',
  'benefitVerification.detail.title': 'Заявка на льготу',
  'benefitVerification.detail.certificateNo': 'Номер сертификата:',
  'benefitVerification.detail.noCertificateNo': 'Не указан',
  'benefitVerification.detail.applicant': 'Заявитель (ID):',
  'benefitVerification.detail.activity': 'Вид деятельности:',
  'benefitVerification.detail.period': 'Запрашиваемый период:',
  'benefitVerification.detail.submittedAt': 'Дата подачи:',
  'benefitVerification.detail.status': 'Статус заявки на льготу:',
  'benefitVerification.detail.decidedBy': 'Решение принял (ID):',
  'benefitVerification.detail.decidedAt': 'Дата решения:',
  'benefitVerification.detail.rejectionReason': 'Причина отклонения:',
  'benefitVerification.detail.loadFailed': 'Не удалось загрузить заявку.',
  'benefitVerification.detail.documents.title': 'Прикрепленные документы',
  'benefitVerification.detail.documents.empty': 'Документы не прикреплены.',
  'benefitVerification.detail.documents.download': 'Скачать',
  'benefitVerification.detail.documents.fallbackName': 'Документ',
  'benefitVerification.actions.verify': 'Подтвердить',
  'benefitVerification.actions.reject': 'Отклонить',
  'benefitVerification.actions.verifyError': 'Не удалось подтвердить.',
  'benefitVerification.reject.title': 'Отклонить заявку на льготу',
  'benefitVerification.reject.reasonLabel': 'Причина отклонения',
  'benefitVerification.reject.reasonPlaceholder': 'Укажите, почему сертификат не подтверждён',
  'benefitVerification.reject.reasonRequired': 'Причину отклонения нужно указать.',
