...
export const ru = {
  ...
  'login.forgotNext': 'Далее',
  'login.forgotChannelTitle': 'Куда отправить код?',
  'login.forgotPhone': 'Телефон',
  'login.forgotEmail': 'E-mail',
  'login.forgotNotFilled': 'не заполнено',
  'login.forgotNoContacts': 'Логин не найден, либо у него не указаны ни телефон, ни e-mail. Обратитесь к администратору.',
  'login.forgotCodeLabel': 'Код из сообщения',
  'login.forgotCodeHelp': '6 цифр, действует несколько минут',
  'login.forgotNewPassword': 'Новый пароль',
  'login.forgotPolicyHelp': 'Не менее 8 символов: заглавные и строчные буквы, цифра и спецсимвол',
  'login.forgotRepeatPassword': 'Повторите пароль',
  'login.forgotSubmit': 'Сменить пароль',
  'login.forgotMismatch': 'Пароли не совпадают.',
  'login.forgotWeakPassword': 'Пароль не подходит: нужно не менее 8 символов, заглавные и строчные буквы, цифра и спецсимвол.',
  'login.forgotDone': 'Пароль изменён. Войдите с новым паролем.',
  'login.adminContact': 'Не получается войти? Обратитесь к администратору или в техподдержку:',
  ...
  'gis.versions.checks.skipped': 'не проверено',
  'gis.versions.checks.skipReason.noGeometry': 'нет геометрии',
  'gis.versions.checks.skipReason.layerEmpty': 'справочный слой ещё не передан',
  ...
  'gis.contours.reviseRequisites': 'Изменить реквизиты (новая версия)',
  'gis.contours.split': 'Разделить',
  'gis.contours.drawHint': 'Нарисуйте контур на карте',
  'gis.contours.noMapOrg': 'Карта ГИС не подключена для этого лесхоза',
  'gis.contours.noMapOrgHint': 'Этот контур создаётся и редактируется только по реквизитам — номер и заявленная площадь. Рисовать геометрию нечего.',
  ...
  'gis.contours.form.noGeometryHint': 'У этого лесхоза нет карты ГИС — укажите заявленную площадь из документов вместо рисования.',
  'gis.contours.form.declaredAreaRequired': 'Заявленная площадь обязательна — вычислить её по карте нельзя.',
  ...
  'permits.signatures.errors.simpleSignatureNotAllowed':
    "Простая подпись без ключа доступна только гражданину, подавшему заявку от себя — для этой строки нужна E-IMZO.",
  ...
  'wizard.step2.noMapTitle': 'В этом лесхозе карта ГИС не подключена',
  'wizard.step2.noMapHint': 'Контуры показываются только по реквизитам: номер, лесхоз и площадь.',
  'wizard.step2.noGeometryForPick': 'Для этого контура нет карты ГИС — он зарегистрирован по реквизитам.',
  ...
  'wizard.step3.deadwoodProduct.both': 'Дрова и ветви',
  'wizard.step3.removalDeadline': 'Срок вывоза',
  'wizard.step3.recreationPurpose': 'Цель использования',
  'wizard.step3.recreationPurpose.cultural_educational': 'Культурно-просветительная',
  'wizard.step3.recreationPurpose.upbringing': 'Воспитательная',
  'wizard.step3.recreationPurpose.health': 'Оздоровительная',
  'wizard.step3.recreationPurpose.recreational': 'Рекреационная',
  'wizard.step3.recreationPurpose.aesthetic': 'Эстетическая',
  'wizard.step3.eventAt': 'Дата и время мероприятия',
  ...
  'wizard.checks.norm_min_term': 'Минимальный срок',
  ...
  'wizard.checks.noMinTerm': 'Для этого вида деятельности минимальный срок не установлен — проверка не требуется.',
  'wizard.checks.minTermFail': 'Запрошенный период — {requested} дн. — короче минимального срока для этого вида деятельности ({min} дн.).',
  'wizard.checks.minTermPass': 'Минимальный срок — {min} дн., запрошенный период ему соответствует.',
  ...
  'nav.beekeepers': 'Реестр пчеловодов',
  'staff.benefitClaim.title': 'Заявка на льготу',
  'staff.benefitClaim.category': 'Категория льготы:',
  'staff.benefitClaim.certificateNo': 'Номер сертификата:',
  'staff.benefitClaim.noCertificateNo': 'Не указан',
  'staff.benefitClaim.status': 'Статус заявки на льготу:',
  'staff.benefitClaim.status.pending': 'Ожидает',
  'staff.benefitClaim.status.verified': 'Подтверждена',
  'staff.benefitClaim.status.rejected': 'Отклонена',
  'staff.benefitClaim.registryVerified': 'Подтверждено по реестру Союза',
  'staff.benefitClaim.rejectionReason': 'Причина отклонения:',
  'staff.benefitClaim.documents.title': 'Прикрепленные документы',
  'staff.benefitClaim.documents.empty': 'Документы не прикреплены.',
  'staff.benefitClaim.documents.download': 'Скачать',
  'staff.benefitClaim.documents.fallbackName': 'Документ',
  'staff.benefitClaim.loadFailed': 'Не удалось загрузить заявку на льготу.',
  'staff.benefitClaim.actions.verify': 'Подтвердить',
  'staff.benefitClaim.actions.reject': 'Отклонить',
  'staff.benefitClaim.actions.verifyError': 'Не удалось подтвердить.',
  'staff.benefitClaim.reject.title': 'Отклонить заявку на льготу',
  'staff.benefitClaim.reject.reasonLabel': 'Причина отклонения',
  'staff.benefitClaim.reject.reasonPlaceholder': 'Укажите, почему сертификат не подтверждён',
  'staff.benefitClaim.reject.reasonRequired': 'Причину отклонения нужно указать.',
  'staff.benefitClaim.reject.submit': 'Отклонить',
  'staff.benefitClaim.reject.cancel': 'Отмена',
  'staff.benefitClaim.reject.error': 'Не удалось отклонить.',
  ...
  'beekeepers.filters.qPlaceholder': 'По сертификату, ФИО или ПИНФЛ',
  'beekeepers.filters.status': 'Статус',
  'beekeepers.filters.all': 'Все',
  'beekeepers.filters.active': 'Активные',
  'beekeepers.filters.removed': 'Исключённые',
  'beekeepers.apply': 'Найти',
  'beekeepers.reset': 'Сбросить',
  'beekeepers.create': 'Зарегистрировать',
  ...
  'beekeepers.status.removed': 'Исключён',
  'beekeepers.action.edit': 'Изменить',
  'beekeepers.action.remove': 'Исключить из реестра',
  'beekeepers.empty': 'Члены не найдены.',
  'beekeepers.loadError': 'Не удалось загрузить список.',
  'beekeepers.form.createTitle': 'Регистрация нового члена',
  'beekeepers.form.editTitle': 'Редактирование данных члена',
  'beekeepers.form.fieldPinfl': 'ПИНФЛ',
  'beekeepers.form.pinflHint':
    '14-значный номер. После ввода, если человек входил в систему через OneID, ФИО и паспортные данные заполнятся автоматически.',
  'beekeepers.form.fieldCertificateNo': 'Номер сертификата',
  'beekeepers.form.fieldFullName': 'ФИО',
  ...
  'beekeepers.remove.title': 'Исключить члена из реестра',
  'beekeepers.remove.reasonLabel': 'Причина',
  'beekeepers.remove.reasonPlaceholder': 'Укажите причину исключения из реестра',
  'beekeepers.remove.reasonRequired': 'Причину нужно указать.',
  ...
  // `application_id` возвращают собственные строки вызывающего-заявителя).
  'myPayments.title': 'Мои платежи',
  'myPayments.subtitle': 'Счета, платежи и запросы на возврат — в одном месте.',
  'myPayments.tabs.invoices': 'Счета',
  'myPayments.tabs.refunds': 'Возвраты',
  'myPayments.filterAll': 'Все',
  'myPayments.invoices.colNumber': 'Счёт',
  'myPayments.invoices.colApplication': 'Заявка',
  'myPayments.invoices.colAmount': 'Сумма',
  'myPayments.invoices.colStatus': 'Статус',
  'myPayments.invoices.colIssued': 'Дата выставления',
  'myPayments.invoices.colDue': 'Срок оплаты',
  'myPayments.invoices.pay': 'Оплатить',
  'myPayments.invoices.open': 'Открыть',
  'myPayments.invoices.empty': 'Счетов пока нет.',
  'myPayments.invoices.emptyHint': 'После одобрения заявки счёт появится здесь.',
  'myPayments.invoices.loadFailed': 'Не удалось загрузить счета.',
  'myPayments.refunds.colApplication': 'Заявка',
  'myPayments.refunds.colBasis': 'Основание',
  'myPayments.refunds.colFinal': 'Сумма к возврату',
  'myPayments.refunds.colStatus': 'Статус',
  'myPayments.refunds.colRequestedAt': 'Дата запроса',
  'myPayments.refunds.colDue': 'Срок ответа',
  'myPayments.refunds.colDecidedAt': 'Дата решения',
  'myPayments.refunds.pendingDecision': 'Ожидает решения',
  'myPayments.refunds.newRequest': 'Запросить возврат',
  'myPayments.refunds.empty': 'Запросов на возврат нет.',
  'myPayments.refunds.loadFailed': 'Не удалось загрузить возвраты.',
  'myPayments.refunds.reasonsLoadFailed': 'Не удалось загрузить основания возврата.',
  'myPayments.refunds.loadingLists': 'Загрузка…',
  'myPayments.refunds.applicationLabel': 'Заявка',
  'myPayments.refunds.basisLabel': 'Основание',
  'myPayments.refunds.commentLabel': 'Комментарий',
  'myPayments.refunds.submit': 'Отправить',
  'myPayments.refunds.cancel': 'Отмена',
  'myPayments.refunds.noBillableApplications': 'Нет заявки со счётом — для возврата сначала должен быть платёж.',
  'myPayments.refunds.requestFailed': 'Не удалось отправить запрос.',
