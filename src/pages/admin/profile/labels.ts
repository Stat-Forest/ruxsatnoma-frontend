...
const uz_latn = {
  ...
  sameAsOld: "Yangi parol joriy paroldan farq qilishi kerak.",
...
const uz_cyrl: Record<keyof typeof uz_latn, string> = {
  ...
  sameAsOld: 'Янги парол жорий паролдан фарқ қилиши керак.',
...
const kaa: Record<keyof typeof uz_latn, string> = {
  ...
  sameAsOld: "Jańa parol házirgi paroldan parıq qılıwı kerek.",
