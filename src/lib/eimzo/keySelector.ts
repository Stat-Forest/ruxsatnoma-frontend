 ...
 * `signAttached` are called from nine places (`PermitSignaturesPanel`,
 * `PermitLifecyclePanel`, `ActSignCard`, `ApplicationWizardPage`,
 * `SignDecisionModal`, `ReportLifecyclePanel`, `CertificatesSection`,
 * `RepresentationSection`, `AuthProvider`), none of which has anything to
 * say about key choice. Threading a picker through all nine — and through
